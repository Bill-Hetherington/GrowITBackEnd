...
namespace GrowITBackEnd.Migrations
{
    ...
    [Migration("20220623183805_initMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Cart_Items", b =>
                {
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Item", b =>
                {
                    b.Property<int>("ItemID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Order_Items", b =>
                {
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Orders", b =>
                {
                    b.Property<int>("OrdersID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Support_Tickets", b =>
                {
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Wishlist", b =>
                {
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Wishlist_Items", b =>
                {
                    b.Property<int>("WishID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Cart_Items", b =>
                {
                    b.HasOne("GrowITBackEnd.Models.Cart", "Cart")
                        .WithMany("cart_Items")
                        .HasForeignKey("CartID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GrowITBackEnd.Models.Item", "Item")
                        .WithMany("cart_Items")
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Order_Items", b =>
                {
                    ...
                    b.HasOne("GrowITBackEnd.Models.Orders", "orders")
                        .WithMany("order_items")
            ...
            modelBuilder.Entity("GrowITBackEnd.Models.Wishlist_Items", b =>
                {
                    ...
                    b.HasOne("GrowITBackEnd.Models.Wishlist", "Wishlist")
                        .WithMany("wishlist_items")
